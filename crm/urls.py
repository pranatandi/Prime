...
urlpatterns = [
    ...
    path("companies/export/", views.CompanyExportView.as_view(), name="company_export"),
    ...
    path("deals/export/", views.DealExportView.as_view(), name="deal_export"),
    ...
    path("activities/export/", views.ActivityExportView.as_view(), name="activity_export"),
