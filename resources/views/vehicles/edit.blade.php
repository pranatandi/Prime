...
<div class="px-4 sm:px-0">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">Edit Vehicle</h1>
    </div>

    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form action="{{ route('vehicles.update', $vehicle->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="type" id="type" required
                        ...
                        <option value="Trailer" {{ old('type', $vehicle->type) == 'Trailer' ? 'selected' : '' }}>Trailer</option>
                ...
                <div>
                    ...
                    <input type="text" name="driver_phone" id="driver_phone" value="{{ old('driver_phone', $vehicle->driver_phone) }}"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="capacity" id="capacity" value="{{ old('capacity', $vehicle->capacity) }}"
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('notes') border-red-500 @enderror">{{ old('notes', $vehicle->notes) }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
